            ...
            <h1>Add Posts</h1>
              <form class="" method="post">
                <div class="form-group">
                  <label>E-mail</label>
                  <input type="text" readonly name="email" value ="<?php echo $maildata; ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Username</label>
                  <input type="text" name="username" class="form-control" value="<?php echo $veld[0]; ?>" >
                </div>
                <div class="form-group">
                  <label>Personal message</label>
                  <textarea type="text" name="personalmessage" class="form-control" rows="5"><?php echo $veld[2]; ?></textarea>
                </div>

                <div class="form-group">
                  <label>Artist 1</label>
                  <input type="text" name="artist1" value ="<?php echo $veld[3];?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Song 1</label>
                  <input type="text" name="song1" class="form-control" value ="<?php echo $veld[4]; ?>">
                </div>
                <div class="form-group">
                  <label>URL 1</label>
                  <input type="text" name="url1" class="form-control" value ="<?php echo $veld[5]; ?>">
                </div>
                <div class="form-group">
                  <label>Artist 2</label>
                  <input type="text" name="artist2" class="form-control" value ="<?php echo $veld[6]; ?>">
                </div>
                <div class="form-group">
                  <label>Song 2</label>
                  <input type="text" name="song2" class="form-control" value ="<?php echo $veld[7]; ?>">
                </div>
                <div class="form-group">
                  <label>URL 2</label>
                  <input type="text" name="url2" class="form-control" value ="<?php echo $veld[8]; ?>">
                </div>
                <div class="form-group">
                  <label>Artist 3</label>
                  <input type="text" name="artist3" class="form-control" value ="<?php echo $veld[9]; ?>">
                </div>
                <div class="form-group">
                  <label>Song 3</label>
                  <input type="text" name="song3" class="form-control" value ="<?php echo $veld[10]; ?>">
                </div>
                <div class="form-group">
                  <label>URL 3</label>
                  <input type="text" name="url3" class="form-control" value ="<?php echo $veld[11]; ?>">
                </div>
...
<br>
                ...
                <a id="resultURL1" href="#" target="_blank">link</a>

                <button class="btn btn-primary" name="search" id="link" type="button">Get link</button>
